...
for (i=1; i<= nfold; i++) {
    ...
    //////////////////////////// data setup ///////////////////////////
    // loads data
    def dir = 'data'+java.io.File.separator +"overlap"+java.io.File.separator + "10gene" + java.io.File.separator;
    ...
    def result_file = new File("result/one_gene/10gene/fold${i}_result.txt");
    result_file.write ""
